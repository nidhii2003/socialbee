...
import 'package:socialbee/validation/validator.dart'; // import the Validator class
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          return Validator.validateEmail(value ?? ''); // Validate when submitting the form
                        },
                      ),
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          return Validator.validatePassword(value ?? ''); // Validate when submitting the form
                        },
                      ),
                      const SizedBox(height: 20),
